...
<CalendarPrimitive.Day
	...
	class={cn(
		...
		// Outside months
		'[&[data-outside-month][data-selected]]:bg-accent-5/50 data-[outside-month]:text-neutral-11 [&[data-outside-month][data-selected]]:text-neutral-11 data-[outside-month]:pointer-events-none data-[outside-month]:opacity-50 [&[data-outside-month][data-selected]]:opacity-30',
		className
	)}
	{...$$restProps}
	let:selected
