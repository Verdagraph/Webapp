...
<div {...restProps} class="@container h-full w-full">
	...
	>
		<div class="flex w-full">
			...
			<span
				class="border-neutral-7 bg-neutral-1 @xs:rounded-tr-none @xs:border-b flex w-full items-center justify-center rounded-l-none rounded-r-none rounded-tr-md border border-b-0"
				>{x}</span
			>
		</div>
		<div class="flex w-full">
			...
			<span
				class="border-neutral-7 bg-neutral-1 @xs:border-b flex w-full items-center justify-center rounded-l-none rounded-r-none border border-b-0"
				>{y}</span
			>
		</div>
		<span
