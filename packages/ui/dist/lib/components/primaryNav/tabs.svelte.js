 ...
 */
export const getGardensAuthTab = (gardens = []) => {
    const viewAllSubmenuItem = {
        url: getGardenBaseUrl(''),
        label: 'View All',
        className: 'underline'
    };
    const gardensSubmenuItems = gardens
 ...
 * @returns Tab specification for the gardens tab.
 */
export const getGardensAnonTab = () => {
 ...
 */
export const getGardenSpecifcTabs = (garden) => {
    return [
        {
            id: 'garden',
            label: 'Garden',
 ...
 */
export const getAuthProfileTab = () => {
    return {
        id: 'profile',
        label: 'Profile',
 ...
 */
export const getAnonProfileTab = () => {
    {
        return {
            id: 'account',
            label: 'Account',
