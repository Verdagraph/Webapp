 ...
 */
export declare function createSelectionManager<const EntityTypes extends readonly string[]>(entityTypes: EntityTypes): {
    tool: SelectionTool;
    ...
    resetAll: () => void;
    addSelectionChangeHandler: (entityType: EntityTypes[number], handler: (addedIds: Array<string>, removedIds: Array<string>) => void) => void;
};
