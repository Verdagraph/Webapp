...
type WorkspaceThumbnail = SvelteComponent<
	{
		[x: string]: never;
	},
	{
...
declare const WorkspaceThumbnail: $$__sveltets_2_IsomorphicComponent<
	{
		[x: string]: never;
	},
	{
...
//# sourceMappingURL=WorkspaceThumbnail.svelte.d.ts.map
