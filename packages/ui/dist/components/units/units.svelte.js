 ...
 */
export function createUnitAwareValues(quantityType, initialValuesMetric, initialUnitSystem = 'metric', decimalPlaces = 2) {
    /** The current unit system for this value. Defaults to user preferences. */
    let unitSystem = $state(initialUnitSystem);
    /** The values displayed in the component. */
    let displayValues = $state(initialUnitSystem === 'metric'
        ? initialValuesMetric
