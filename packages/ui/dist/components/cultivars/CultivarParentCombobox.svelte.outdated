...
>
	<div class="relative">
		<Combobox.Input
			class="border-neutral-11 bg-neutral-1 placeholder:text-neutral-11 focus-visible:ring-primary-6 h-10 w-full rounded-md border px-3 py-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
	...
	<Combobox.Content
		class="border-neutral-10 bg-neutral-2 w-full rounded-xl border px-1 py-3 shadow-md outline-none"
		transition={flyAndScale}
		sideOffset={8}
	>
		{#each filteredOptions as cultivar (cultivar.value)}
			<Combobox.Item
				class="data-[highlighted]:bg-neutral-3 flex h-8 w-full select-none items-center rounded-md py-3 pl-5 pr-1.5 text-sm capitalize outline-none transition-all duration-75"
