 ...
 */
export declare function createCalendarContext<
...
>(
	...
	timeline: {
		...
		changeBeginSelection: (
			newBeginSelection: import('@internationalized/date').DateValue
		) => void;
		changeEndSelection: (
			newEndSelection: import('@internationalized/date').DateValue
		) => void;
		translate: (translation: import('@internationalized/date').DateDuration) => void;
		sliderValueToDateValue: (
			sliderValue: number
		) => import('@internationalized/date').DateValue;
 ...
 */
export declare function createCalendarContainerContext(
	timeline: TimelineSelection,
	config: LocalStore<CalendarConfig>
): {
	width: number;
 ...
 */
export declare function createCalendarPaneContext(spec: CalendarPaneSpec): {
	/** Getters. */
	height: number;
	tree: any;
};
