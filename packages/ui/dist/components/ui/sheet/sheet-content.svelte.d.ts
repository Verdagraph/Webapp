...
export declare const sheetVariants: import('tailwind-variants').TVReturnType<
	...
	undefined,
	'bg-neutral-1 data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 gap-4 p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500',
