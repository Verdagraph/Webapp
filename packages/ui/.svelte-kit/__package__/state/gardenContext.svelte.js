...
export function createGardenContext(controller) {
    ...
    const gardenQuery = $derived(useQuery(controller.triplit, controller.triplit.query('gardens').Id(id)));
