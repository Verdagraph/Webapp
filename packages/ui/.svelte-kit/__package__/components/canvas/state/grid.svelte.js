...
export function createCanvasGridManager(container, transform) {
    /** Konva elements. */
    ...
    const pixelsPerBackgroundGridline = $derived(container.pixelsPerMeter * config.value.metersPerBackgroundGridline);
    function initialize() {
