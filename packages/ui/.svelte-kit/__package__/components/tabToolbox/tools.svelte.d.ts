 ...
 */
export type ToolAttributes<ToolId extends string> = readonly ToolAttributeType<ToolId>[];
export declare function createToolbox<ToolId extends string>(attributes: ToolAttributes<ToolId>): {
