...
const lastFrostWindowOpenSchema = z.number().describe('The amount of days between the last frost and the beginning of the planting window. \
...
const lastFrostWindowCloseSchema = z.number().describe('The amount of days between the last frost and the end of the planting window. \
			Positive values indicate the window begins after the last frost date. \
			For example, a value of 15 indicates the cultivar must be planted before 15 days after the last frost date.');
const firstFrostWindowOpenSchema = z.number().describe('The amount of days between the first frost and the beginning of the planting window. \
...
const firstFrostWindowCloseSchema = z.number().describe('The amount of days between the first frost and the end of the planting window. \
			Positive values indicate the window begins after the first frost date. \
...
export const FrostDatePlantingWindowsUpdateCommandSchema = z
    ...
    .describe('A planting window defines a period of time within an environment that a cultivar should be planted. \
