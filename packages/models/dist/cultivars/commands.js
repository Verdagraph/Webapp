...
const cultivarNameSchema = z
    ...
    .regex(/^[0-9A-Za-z _-]+$/, 'Must contain only letters, numbers, spaces, hyphens, and underscores.')
...
const cultivarCollectionVisibilitySchema = z
    ...
    .describe('Public collections may be viewed by anyone and are publicly searchable. \
