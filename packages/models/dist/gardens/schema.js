import { Schema as S, or } from '@triplit/client';
 ...
 */
export const GardenVisibilityEnumOptions = ['HIDDEN', 'UNLISTED', 'PUBLIC'];
/**
 ...
 */
export const GardenMembershipRoleEnumOptions = ['ADMIN', 'EDITOR', 'VIEWER'];
/**
