...
const geometryTypeSchema = z
    ...
    .describe('Describes the type of geometry. Each type has a unique set of attributes associated with it.');
...
const geometryScaleFactorSchema = z
    ...
    .describe('Factor used to scale the geometry up or down. Must be within 1 and 1000 percent.');
const geometryRotationSchema = z
    .number()
    .min(-360, 'Must be at least negative 360 degrees.')
    .max(360, 'May be at most 360 degrees.')
    .describe('The rotation of the geometry in degrees. Must be between 0 and 360 degrees.');
...
const geometryEllipseWidthSchema = z
    ...
    .min(0.01, 'May not be negative or zero.')
    .max(1000, 'May be at most 1000m')
    .describe('The vertical, or y-axis diameter of the ellipse. Must be between 0 and 1000 meters.');
const geometryLinesCoordinatesSchema = z
    .array(coordinateSchema)
    .min(3, 'Must have at least 3 points.')
    .describe('A list of coordinates relative to the position of the geometry which define an irregular polygonal.');
