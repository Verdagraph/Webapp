		...
		routes: [
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/blog/_server.ts.js'))
			},
			{
				id: "/api/docs",
				pattern: /^\/api\/docs\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/docs/_server.ts.js'))
			},
			{
				id: "/blog",
				pattern: /^\/blog\/?$/,
...
export const prerendered = new Set(["/","/about","/api/search","/docs","/docs/__data.json","/support","/docs/introduction","/docs/faq","/docs/concepts","/docs/self-hosting","/docs/garden-management","/docs/workspace-environment-config","/docs/cultivar-config","/docs/garden-setup","/docs/first-plan"]);
