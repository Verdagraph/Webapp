...
function _page($$payload) {
	head($$payload, ($$payload2) => {
		$$payload2.title = `<title>Verdagraph - Landing Page</title>`;
	});
	$$payload.out += `<div><h1>Open source eco-modelling tools for collaboratively organized agriculture.</h1> <h1>Plan, track, optimize, and automate your garden with Verdagraph.</h1> <h1>Modern industrial agriculture is unsustainable. It also is difficult to compete
