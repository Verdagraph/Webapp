...
type RouteId = '/gardens/[gardenId]/(config)/workspaces';
...
type LayoutRouteId = RouteId | "/gardens/[gardenId]/(config)/workspaces" | "/gardens/[gardenId]/(config)/workspaces/[workspaceSlug]" | "/gardens/[gardenId]/(config)/workspaces/create"
