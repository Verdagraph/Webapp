...
type RouteId = '/(app)/app/gardens/[gardenId]/(config)/workspaces';
...
type LayoutRouteId = RouteId | "/(app)/app/gardens/[gardenId]/(config)/workspaces" | "/(app)/app/gardens/[gardenId]/(config)/workspaces/[workspaceSlug]" | "/(app)/app/gardens/[gardenId]/(config)/workspaces/create"
