...
type RouteId = '/(app)/app/gardens/[gardenKey]/(config)/workspaces';
...
type LayoutRouteId = RouteId | "/(app)/app/gardens/[gardenKey]/(config)/workspaces" | "/(app)/app/gardens/[gardenKey]/(config)/workspaces/[workspaceSlug]" | "/(app)/app/gardens/[gardenKey]/(config)/workspaces/create"
